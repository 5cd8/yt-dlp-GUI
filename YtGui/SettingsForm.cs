...
namespace YtGui
{
    public class SettingsForm : Form
    {
        ...
        public SettingsForm(Settings s)
        {
            ...
            var layout = new TableLayoutPanel { Dock = DockStyle.Top, AutoSize = true, AutoSizeMode = AutoSizeMode.GrowAndShrink, ColumnCount = 3, RowCount = 8 };
            ...
            layout.Controls.Add(new Label { Text = "リトライ回数", AutoSize = true }, 0, 4);
            layout.Controls.Add(nudRetry, 1, 4);

            layout.Controls.Add(new Label { Text = "リトライ間隔(秒)", AutoSize = true }, 0, 5);
            layout.Controls.Add(nudDelay, 1, 5);

            layout.Controls.Add(chkNoPart, 1, 6);
